...
## Note
This is a forked repository from https://github.com/chenyuntc/simple-faster-rcnn-pytorch/ which enables Faster R-CNN detection and classification without Cython and other packages.
