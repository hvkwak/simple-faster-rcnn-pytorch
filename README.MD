...
## Note
This is a forked repository from https://github.com/chenyuntc/simple-faster-rcnn-pytorch/ which is enabled to implement FASTER-RCNN without using Cython and other packages.
