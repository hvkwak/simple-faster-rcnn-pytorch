...
## Note
This is a forked repository from https://github.com/chenyuntc/simple-faster-rcnn-pytorch/ which is enabled to use Faster R-CNN detection, classification architecture without Cython and other packages.
